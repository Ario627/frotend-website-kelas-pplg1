...
export const AnnouncementCard = memo(function AnnouncementCard({
  ...
  return (
    ...
    >
      <PixelCard
        hover={false}
        className={`p-5 relative transition-all ${announcement.isPinned
      ...
      >
        ...
        <div className="flex items-start justify-between gap-3 mb-3">
          ...
          {/* Admin Menu - Muncul on hover/touch */}
          <AnimatePresence>
            {canShowAdminMenu && isHovered && (
              <motion.div
                ...
                <DropdownMenu.Root>
                  <DropdownMenu.Trigger asChild>
                    <button
                      ...
                      aria-label="Menu"
                    >
                      <MoreHorizontal size={16} className="text-[rgb(var(--slate))]" />
                    </button>
        ...
        <p className="text-xs text-[rgb(var(--slate))] line-clamp-3 mb-4 leading-relaxed">
          {announcement.content}
        </p>

        {/* Footer - Views & Reactions */}
        <div className="flex items-center justify-between pt-3 border-t border-[rgb(var(--border))] gap-2">
          {/* Views */}
