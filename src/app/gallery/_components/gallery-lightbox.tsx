            ...
            <Dialog.Content asChild>
              ...
              >
                <div className="relative w-full max-w-4xl flex flex-col max-h-[90vh]">
                  ...
                  <div className="relative overflow-hidden bg-black/40 flex items-center justify-center min-h-70 flex-1">
                    {item.type === 'video' && item.youtubeVideoId && /^[a-zA-Z0-9_-]{11}$/.test(item.youtubeVideoId) ? (
                      ...
                      /* Image with zoom */
                      <div
                        className="relative flex items-center justify-center overflow-hidden w-full h-full cursor-zoom-in min-h-70"
